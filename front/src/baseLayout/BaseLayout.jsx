    ...
    <>
      <header className="header">
        <nav className="navbar">
          ...
          <a className="nameBrand" href="/">
            Nexe Fundació
          </a>

          <div className="nav-right">
            <button className="btn-all-pages" onClick={activeNavAllPages}>
              Menú de Opciones
            </button>
          </div>
        ...
        >
          <div className="cookies-content">
            ...
            <div className="cookies-buttons">
              <button id="accept-cookies" className="btn-accept">
                Aceptar
              </button>
              <button id="decline-cookies" className="btn-decline">
                Rechazar
              </button>
            </div>
          </div>
