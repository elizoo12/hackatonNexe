...
<nav class="navbar" role="navigation" aria-label="Menú principal">
    ...
    <a class="nameBrand" href="/" >Nexe Fundació</a>
    <div class="searcher-row">

        <input id="searchInput" class="search-input-bar" type="search" placeholder="Busca por palabra..." aria-label="Buscar productos" />
        <button id="searchBtn" class="search-btn" type="button" aria-label="Buscar">  
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24">
...
<footer class="footer" id="footer">
    <div class="nameBrandFooter"> <a href="/">Nexe Fundació</a></div>
    <div class="row-info">
...
<div class="cookies-overlay" id="cookies-overlay">
    <div id="cookies-banner" class="cookies-banner" role="dialog" aria-modal="true" aria-labelledby="nav-cookies">
        ...
        <div class="cookies-content">
            ...
            <div class="cookies-buttons">
                ...
                <button id="decline-cookies" class="btn-decline">Rechazar</button>
            </div>
        </div>
    </div>
</div>
